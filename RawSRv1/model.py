...
class Branch2(nn.Module):
    def __init__(self, config):
        ...
        self.l1_conv = ConvBlock(4, self.inner_channels, self.kernel_size_conv)
        self.l2_pool = ConvBlock(self.inner_channels, self.inner_channels, self.kernel_size_pool, stride=2)
        self.l3_conv = ConvBlock(self.inner_channels, self.inner_channels, self.kernel_size_conv)
        self.l4_pool = ConvBlock(self.inner_channels, self.inner_channels, self.kernel_size_pool, stride=2)
        ...
        #                                              kernel_size=[4, 4], reuse=self.reuse, stride=2,
        #                                              scope='deconv_2_0_0',
        ...
        #                                              reuse=self.reuse,
        #                                              stride=Scale, scope='deconv_2_0_2',
        #                                              activation_fn=model_tools.lrelu)
